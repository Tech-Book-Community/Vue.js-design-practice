...
<div class="text-center">
  <div class="text-4xl text-gray-300 leading-relaxed mb-20">
    給每個虛擬節點一個<br>
    <span class="text-green-400 font-bold text-5xl">唯一的標識</span>
  </div>

  <div class="text-8xl font-bold text-blue-400 font-mono">
    key
  </div>
</div>

<!--
為了解決無法確定節點對應關係的問題，我們需要給每個虛擬節點一個唯一的標識。
...
<div v-click class="mt-12 text-center">
  <div class="text-3xl text-red-400 font-bold mb-4">
    <div class="i-carbon-help inline-block text-4xl align-middle mr-2"></div>
    無法確定對應關係
  </div>
  <div class="text-xl text-gray-300">
    所有節點的 type 都是 <span class="font-mono text-yellow-300">'p'</span>
  </div>
  <div class="text-lg text-gray-400 mt-2">
    新 children 的第一個節點（children: '3'）是舊 children 的哪一個？
  </div>
</div>
...
[點擊] 問題：所有節點的 type 都是 'p'，我們無法確定新 children 中的第一個節點（children: '3'）到底是舊 children 中的哪一個。
-->
...
<div class="text-center">
  <div class="text-4xl text-yellow-300 mb-20">
    key 屬性就像虛擬節點的 <span class="font-bold">"身份證號"</span>
  </div>
...
```js {all|8-9|11-12|14-19|all}{lines:true}
...
<div class="text-center">
  ...
  <div v-click class="text-4xl text-gray-300 leading-relaxed">
    具體要怎麼<span class="text-green-400 font-bold">移動</span>這些節點呢？
  </div>
</div>
...
[點擊] 現在我們有了 key 屬性，可以確定哪些節點可以復用了。
