...
const currentState = computed(() => {
  ...
  if (clicks >= 9) {
    // Click 9: Execute move animation - p-1 moves after p-3
    domNodes = [
      { key: 'p-1', oldIndex: 0, y: 240, highlight: true, removing: false }, // move to position 3
      ...
      { key: 'p-4', oldIndex: 3, y: 160, highlight: false, removing: false }, // move to position 2
    ]
    oldHighlight[0] = true
    connection = {
      fromY: 80 + 40,
    ...
    lastIndex = 2
    message = '移動完成：真實 DOM 順序變為 [p-2, p-3, p-4, p-1]'
  }
  ...
  if (clicks >= 10) {
    ...
    domNodes = [
      ...
      { key: 'p-4', oldIndex: 3, y: 160, highlight: false, removing: false },
      { key: 'p-1', oldIndex: 0, y: 240, highlight: false, removing: false },
    ]
    lastIndex = 2
    message = '✓ 更新階段完成！真實 DOM 順序為 [p-2, p-3, p-4, p-1]'
  }
  ...
  if (clicks >= 13) {
    ...
    domHighlight[0] = false
    message = 'p-2 已被移除！真實 DOM 順序變為 [p-3, p-4, p-1]'
  }
      ...
      <div class="main-layout">
        ...
        <div class="layers-grid">
          ...
          <div class="layer-column">
            ...
            <svg width="100%" height="320" viewBox="0 0 130 320" class="layer-svg">
          ...
          <div class="connection-column">
            ...
            <svg width="100%" height="320" viewBox="-5 0 90 320" class="layer-svg" style="overflow: visible;">
              <line
